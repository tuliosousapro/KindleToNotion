...
3. Enter:
   ...
   - **Notion Database ID**: Found in the database URL (e.g., `https://www.notion.so/f7979b5aae9e4xerequinha2f8fab46?v=796ed82exemplokabal790a096` → `98a0examplepage244bc0`).
